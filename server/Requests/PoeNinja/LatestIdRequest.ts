...
export class LatestIdRequest extends Request {
    ...
    private wrongResponseError: string = 'Poe ninja api id body should be valid json string';
    ...
    private getIdFromResponse (body: string): string {
        ...
        if (typeof parsedBody !== 'object' || typeof parsedBody.next_change_id !== 'string') {
            throw new Error(this.wrongResponseError);
        }
